    ...
    <ul class="header_menu">
            ...
            <div class="dropdown_wrapper messages_item dropdown-menu dropdown-menu-right">
                ...
                <ul class="dropdown_body nice_scroll scrollbar">
                    <li>
                        <a href="#">
                            <div class="img-part">
                                <img src="{{ asset('user/panel/assets/images/user1.jpg') }}" alt="" class="img-fluid">
                            </div>
                            <div class="text-part">
                    ...
                    <li>
                        <a href="#">
                            <div class="img-part">
                                <img src="{{ asset('user/panel/assets/images/user2.jpg') }}" alt="" class="img-fluid">
                            </div>
                            <div class="text-part">
                    ...
                    <li>
                        <a href="#">
                            <div class="img-part">
                                <img src="{{ asset('user/panel/assets/images/user3.jpg') }}" alt="" class="img-fluid">
                            </div>
                            <div class="text-part">
        ...
        <li><a data-toggle="dropdown" href="#"><i class="far fa-user"></i></a>
            <div class="user_item dropdown-menu dropdown-menu-right">
                <div class="admin">
                    <a href="#" class="user_link"><img src="{{ asset('user/panel/assets/images/admin.jpg') }}"
                            alt=""></a>
                </div>
                <ul>

                    <li><a href="{{ route('user.profile') }}"><span><i class="fas fa-user"></i></span> User Profile</a></li>
                    <li><a href="{{ route('user.change.password') }}"><span><i class="fas fa-cogs"></i></span> Password Change</a></li>
                    <li>
